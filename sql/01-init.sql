-- ================================================================
-- SKILLBUILDERS — Base Schema (runs first on container init)
-- ================================================================

CREATE DATABASE IF NOT EXISTS skillbuilders;
USE skillbuilders;
...
-- Default admin account (plain-text password — admin logs in separately from users/instructors)
