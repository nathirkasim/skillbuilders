...
public class AddToCart extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // FIXED: get userId from session, not from JSON body (was a security hole — anyone could add to any user's cart)
        ...
        try {
            ...
            if (success) {
                ...
                response.getWriter().write("{\"status\":\"error\",\"message\":\"Item already exists in your cart.\"}");
            }
